...
Begin VB.Form FormTambahAgamaUntukIDP 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Tambah Agama Lain"
   ClientHeight    =   1440
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   3480
   ...
   EndProperty
   Icon            =   "FormTambahAgamaUntukIDP.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   1440
   ...
   Begin Dacara_dcButton.dcButton cmOK 
      ...
      EndProperty
      PicAlign        =   5
      PicDown         =   "FormTambahAgamaUntukIDP.frx":0442
      PicHot          =   "FormTambahAgamaUntukIDP.frx":075C
      PicNormal       =   "FormTambahAgamaUntukIDP.frx":0A76
      PicSize         =   2
      PicSizeH        =   24
      PicSizeW        =   24
   End
   ...
   Begin Dacara_dcButton.dcButton cmBatal 
      ...
      EndProperty
      PicAlign        =   3
      PicDown         =   "FormTambahAgamaUntukIDP.frx":0D90
      PicHot          =   "FormTambahAgamaUntukIDP.frx":11E2
      PicNormal       =   "FormTambahAgamaUntukIDP.frx":1634
      PicSize         =   2
      PicSizeH        =   24
      PicSizeW        =   24
   End
   ...
   End
End
Attribute VB_Name = "FormTambahAgamaUntukIDP"
...
BunuhError:
    HancurkanError
    Form_IDENTITAS_PRIBADI.AdodcAgama.Refresh
End Sub
...
With FormTambahAgamaUntukIDP
    ...
    Else
        .Caption = "Agama Lain"
        Label1.Caption = "Tambahkan Agama Lain : "
...
Sub PENGATURAN_BAHASA()
    If FormPengaturan.cmbBahasa.ListIndex = 0 Then
        Me.Caption = "Tambahkan Agama Lain"
        Label1.Caption = "Tambahkan Agama Lain : "
        cmBatal.Caption = "&Batal"
        cmOK.Caption = "&OK/Simpan"
    ElseIf FormPengaturan.cmbBahasa.ListIndex = 1 Then
        Me.Caption = "Add Other Religion"
        Label1.Caption = "Add Other Religion : "
        cmBatal.Caption = "&Cancel"
        cmOK.Caption = "&OK/Save"
    End If
End Sub
