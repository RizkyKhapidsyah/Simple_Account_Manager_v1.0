...
Begin VB.Form FormTambahGolonganDarah 
   BackColor       =   &H00E0E0E0&
   ...
   EndProperty
   Icon            =   "FormTambahGolonganDarah.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   1440
   ...
   Begin Dacara_dcButton.dcButton cmOK 
      ...
      EndProperty
      PicAlign        =   5
      PicDown         =   "FormTambahGolonganDarah.frx":0442
      PicHot          =   "FormTambahGolonganDarah.frx":0794
      PicNormal       =   "FormTambahGolonganDarah.frx":0AE6
      PicSize         =   1
      PicSizeH        =   16
      PicSizeW        =   16
   End
   Begin AeroSuite.AeroTextBox textGolonganDarah 
      Height          =   375
      Left            =   120
      TabIndex        =   1
      Top             =   480
   ...
   End
End
Attribute VB_Name = "FormTambahGolonganDarah"
...
If textGolonganDarah.Text = "" Then
...
Else
    With Form_IDENTITAS_PRIBADI
        .AdodcGolonganDarah.Recordset.AddNew
        .AdodcGolonganDarah.Recordset.Fields(0).Value = textGolonganDarah.Text
        .AdodcGolonganDarah.Recordset.Update
        .AdodcGolonganDarah.Refresh
            .cmbGolonganDarah.Clear
            ...
            Loop
            .cmbGolonganDarah.Text = textGolonganDarah.Text
    End With
    Unload Me
End If
Exit Sub
BinasakanlahError:
    HancurkanError
    Form_IDENTITAS_PRIBADI.AdodcGolonganDarah.Refresh
End Sub
